...
createSVGContainer = function(name, width, height) {
	if (width == null) { width = xmax }
	if (height == null) { height = ymax }
	document.body.appendChild(addSVG("svg", { id: name, width: width, height: height}))
}
...
drawPath = function(coords, stroke, weight, domID, id) {
	path( {
